...
#ifndef SOAP_TYPE___ns1__SampleTest_DEFINED
#define SOAP_TYPE___ns1__SampleTest_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__SampleTest(struct soap*, struct __ns1__SampleTest *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__SampleTest(struct soap*, const struct __ns1__SampleTest *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__SampleTest(struct soap*, const char*, int, const struct __ns1__SampleTest *, const char*);
SOAP_FMAC3 struct __ns1__SampleTest * SOAP_FMAC4 soap_in___ns1__SampleTest(struct soap*, const char*, struct __ns1__SampleTest *, const char*);

SOAP_FMAC3 struct __ns1__SampleTest * SOAP_FMAC4 soap_new___ns1__SampleTest(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__SampleTest(struct soap*, const struct __ns1__SampleTest *, const char*, const char*);

#ifndef soap_write___ns1__SampleTest
#define soap_write___ns1__SampleTest(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize___ns1__SampleTest(soap, data), 0) || soap_put___ns1__SampleTest(soap, data, "-ns1:SampleTest", "") || soap_end_send(soap), (soap)->error )
#endif


#ifndef soap_PUT___ns1__SampleTest
#define soap_PUT___ns1__SampleTest(soap, URL, data) ( soap_free_temp(soap), soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize___ns1__SampleTest(soap, data), 0) || soap_put___ns1__SampleTest(soap, data, "-ns1:SampleTest", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_PATCH___ns1__SampleTest
#define soap_PATCH___ns1__SampleTest(soap, URL, data) ( soap_free_temp(soap), soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize___ns1__SampleTest(soap, data), 0) || soap_put___ns1__SampleTest(soap, data, "-ns1:SampleTest", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_POST_send___ns1__SampleTest
#define soap_POST_send___ns1__SampleTest(soap, URL, data) ( soap_free_temp(soap), ( soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize___ns1__SampleTest(soap, data), 0) || soap_put___ns1__SampleTest(soap, data, "-ns1:SampleTest", "") || soap_end_send(soap) ) && soap_closesock(soap), (soap)->error )
#endif

SOAP_FMAC3 struct __ns1__SampleTest * SOAP_FMAC4 soap_get___ns1__SampleTest(struct soap*, struct __ns1__SampleTest *, const char*, const char*);

#ifndef soap_read___ns1__SampleTest
#define soap_read___ns1__SampleTest(soap, data) ( ((data) ? (soap_default___ns1__SampleTest(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get___ns1__SampleTest(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef soap_GET___ns1__SampleTest
#define soap_GET___ns1__SampleTest(soap, URL, data) ( soap_GET(soap, URL, NULL) || soap_read___ns1__SampleTest(soap, (data)), soap_closesock(soap) )
#endif


#ifndef soap_POST_recv___ns1__SampleTest
#define soap_POST_recv___ns1__SampleTest(soap, data) ( soap_read___ns1__SampleTest(soap, (data)) || soap_closesock(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE__ns2__SampleTestRes_DEFINED
#define SOAP_TYPE__ns2__SampleTestRes_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default__ns2__SampleTestRes(struct soap*, struct _ns2__SampleTestRes *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize__ns2__SampleTestRes(struct soap*, const struct _ns2__SampleTestRes *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns2__SampleTestRes(struct soap*, const char*, int, const struct _ns2__SampleTestRes *, const char*);
SOAP_FMAC3 struct _ns2__SampleTestRes * SOAP_FMAC4 soap_in__ns2__SampleTestRes(struct soap*, const char*, struct _ns2__SampleTestRes *, const char*);

SOAP_FMAC3 struct _ns2__SampleTestRes * SOAP_FMAC4 soap_new__ns2__SampleTestRes(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put__ns2__SampleTestRes(struct soap*, const struct _ns2__SampleTestRes *, const char*, const char*);

#ifndef soap_write__ns2__SampleTestRes
#define soap_write__ns2__SampleTestRes(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize__ns2__SampleTestRes(soap, data), 0) || soap_put__ns2__SampleTestRes(soap, data, "ns2:SampleTestRes", "") || soap_end_send(soap), (soap)->error )
#endif


#ifndef soap_PUT__ns2__SampleTestRes
#define soap_PUT__ns2__SampleTestRes(soap, URL, data) ( soap_free_temp(soap), soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize__ns2__SampleTestRes(soap, data), 0) || soap_put__ns2__SampleTestRes(soap, data, "ns2:SampleTestRes", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_PATCH__ns2__SampleTestRes
#define soap_PATCH__ns2__SampleTestRes(soap, URL, data) ( soap_free_temp(soap), soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize__ns2__SampleTestRes(soap, data), 0) || soap_put__ns2__SampleTestRes(soap, data, "ns2:SampleTestRes", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_POST_send__ns2__SampleTestRes
#define soap_POST_send__ns2__SampleTestRes(soap, URL, data) ( soap_free_temp(soap), ( soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize__ns2__SampleTestRes(soap, data), 0) || soap_put__ns2__SampleTestRes(soap, data, "ns2:SampleTestRes", "") || soap_end_send(soap) ) && soap_closesock(soap), (soap)->error )
#endif

SOAP_FMAC3 struct _ns2__SampleTestRes * SOAP_FMAC4 soap_get__ns2__SampleTestRes(struct soap*, struct _ns2__SampleTestRes *, const char*, const char*);

#ifndef soap_read__ns2__SampleTestRes
#define soap_read__ns2__SampleTestRes(soap, data) ( ((data) ? (soap_default__ns2__SampleTestRes(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get__ns2__SampleTestRes(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef soap_GET__ns2__SampleTestRes
#define soap_GET__ns2__SampleTestRes(soap, URL, data) ( soap_GET(soap, URL, NULL) || soap_read__ns2__SampleTestRes(soap, (data)), soap_closesock(soap) )
#endif


#ifndef soap_POST_recv__ns2__SampleTestRes
#define soap_POST_recv__ns2__SampleTestRes(soap, data) ( soap_read__ns2__SampleTestRes(soap, (data)) || soap_closesock(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE__ns2__SampleTestReq_DEFINED
#define SOAP_TYPE__ns2__SampleTestReq_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default__ns2__SampleTestReq(struct soap*, struct _ns2__SampleTestReq *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize__ns2__SampleTestReq(struct soap*, const struct _ns2__SampleTestReq *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns2__SampleTestReq(struct soap*, const char*, int, const struct _ns2__SampleTestReq *, const char*);
SOAP_FMAC3 struct _ns2__SampleTestReq * SOAP_FMAC4 soap_in__ns2__SampleTestReq(struct soap*, const char*, struct _ns2__SampleTestReq *, const char*);

SOAP_FMAC3 struct _ns2__SampleTestReq * SOAP_FMAC4 soap_new__ns2__SampleTestReq(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put__ns2__SampleTestReq(struct soap*, const struct _ns2__SampleTestReq *, const char*, const char*);

#ifndef soap_write__ns2__SampleTestReq
#define soap_write__ns2__SampleTestReq(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize__ns2__SampleTestReq(soap, data), 0) || soap_put__ns2__SampleTestReq(soap, data, "ns2:SampleTestReq", "") || soap_end_send(soap), (soap)->error )
#endif


#ifndef soap_PUT__ns2__SampleTestReq
#define soap_PUT__ns2__SampleTestReq(soap, URL, data) ( soap_free_temp(soap), soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize__ns2__SampleTestReq(soap, data), 0) || soap_put__ns2__SampleTestReq(soap, data, "ns2:SampleTestReq", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_PATCH__ns2__SampleTestReq
#define soap_PATCH__ns2__SampleTestReq(soap, URL, data) ( soap_free_temp(soap), soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize__ns2__SampleTestReq(soap, data), 0) || soap_put__ns2__SampleTestReq(soap, data, "ns2:SampleTestReq", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_POST_send__ns2__SampleTestReq
#define soap_POST_send__ns2__SampleTestReq(soap, URL, data) ( soap_free_temp(soap), ( soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize__ns2__SampleTestReq(soap, data), 0) || soap_put__ns2__SampleTestReq(soap, data, "ns2:SampleTestReq", "") || soap_end_send(soap) ) && soap_closesock(soap), (soap)->error )
#endif

SOAP_FMAC3 struct _ns2__SampleTestReq * SOAP_FMAC4 soap_get__ns2__SampleTestReq(struct soap*, struct _ns2__SampleTestReq *, const char*, const char*);

#ifndef soap_read__ns2__SampleTestReq
#define soap_read__ns2__SampleTestReq(soap, data) ( ((data) ? (soap_default__ns2__SampleTestReq(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get__ns2__SampleTestReq(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef soap_GET__ns2__SampleTestReq
#define soap_GET__ns2__SampleTestReq(soap, URL, data) ( soap_GET(soap, URL, NULL) || soap_read__ns2__SampleTestReq(soap, (data)), soap_closesock(soap) )
#endif


#ifndef soap_POST_recv__ns2__SampleTestReq
#define soap_POST_recv__ns2__SampleTestReq(soap, data) ( soap_read__ns2__SampleTestReq(soap, (data)) || soap_closesock(soap), (soap)->error )
#endif
...
#ifndef SOAP_TYPE_PointerTo_ns2__SampleTestRes_DEFINED
#define SOAP_TYPE_PointerTo_ns2__SampleTestRes_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_ns2__SampleTestRes(struct soap*, struct _ns2__SampleTestRes *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_ns2__SampleTestRes(struct soap*, const char *, int, struct _ns2__SampleTestRes *const*, const char *);
SOAP_FMAC3 struct _ns2__SampleTestRes ** SOAP_FMAC4 soap_in_PointerTo_ns2__SampleTestRes(struct soap*, const char*, struct _ns2__SampleTestRes **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns2__SampleTestRes(struct soap*, struct _ns2__SampleTestRes *const*, const char*, const char*);
SOAP_FMAC3 struct _ns2__SampleTestRes ** SOAP_FMAC4 soap_get_PointerTo_ns2__SampleTestRes(struct soap*, struct _ns2__SampleTestRes **, const char*, const char*);
#endif

#ifndef SOAP_TYPE_PointerTo_ns2__SampleTestReq_DEFINED
#define SOAP_TYPE_PointerTo_ns2__SampleTestReq_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_ns2__SampleTestReq(struct soap*, struct _ns2__SampleTestReq *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_ns2__SampleTestReq(struct soap*, const char *, int, struct _ns2__SampleTestReq *const*, const char *);
SOAP_FMAC3 struct _ns2__SampleTestReq ** SOAP_FMAC4 soap_in_PointerTo_ns2__SampleTestReq(struct soap*, const char*, struct _ns2__SampleTestReq **, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns2__SampleTestReq(struct soap*, struct _ns2__SampleTestReq *const*, const char*, const char*);
SOAP_FMAC3 struct _ns2__SampleTestReq ** SOAP_FMAC4 soap_get_PointerTo_ns2__SampleTestReq(struct soap*, struct _ns2__SampleTestReq **, const char*, const char*);
#endif
